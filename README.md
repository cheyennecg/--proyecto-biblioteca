...
📈 Número total de préstamos realizados durante el año.

🕒 Horarios de mayor demanda, tanto en análisis semanal como mensual.

📚 Géneros literarios más solicitados, identificando tendencias de lectura.
...
Detectar los géneros con mayor rotación.

Analizar los periodos de mayor actividad para optimizar recursos.
...
Este proyecto demuestra cómo el análisis de datos puede aportar valor a la gestión bibliotecaria, optimizando recursos, mejorando la experiencia del usuario y respaldando decisiones basadas en evidencia.
